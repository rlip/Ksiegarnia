<?php
/**
 * File for class AllegroStructCategoryPathType
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructCategoryPathType originally named CategoryPathType
 ...
 * @version 1
 */
class AllegroStructCategoryPathType extends AllegroWsdlClass
{
    /**
     * The categoryId
     * @var int
    ...
    /**
     * Constructor method for CategoryPathType
     * @see parent::__construct()
     * @param int $_categoryId
     * @param string $_categoryName
     * @param int $_categoryParentId
     * @return AllegroStructCategoryPathType
     */
    public function __construct($_categoryId = NULL,$_categoryName = NULL,$_categoryParentId = NULL)
    {
        parent::__construct(array('categoryId'=>$_categoryId,'categoryName'=>$_categoryName,'categoryParentId'=>$_categoryParentId),false);
    }
    /**
