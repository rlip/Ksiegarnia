<?php
/**
 * File for class AllegroStructCategoryTreeType
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructCategoryTreeType originally named CategoryTreeType
 ...
 * @version 1
 */
class AllegroStructCategoryTreeType extends AllegroWsdlClass
{
    /**
     * The categoryId
     * @var int
    ...
    /**
     * Constructor method for CategoryTreeType
