<?php
/**
 * File for class AllegroStructDoGetServiceTemplatesRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetServiceTemplatesRequest originally named DoGetServiceTemplatesRequest
 ...
 * @version 1
 */
class AllegroStructDoGetServiceTemplatesRequest extends AllegroWsdlClass
{
    /**
     * The countryCode
     * @var int
    ...
    public $webapiKey;
    /**
     * Constructor method for DoGetServiceTemplatesRequest
     * @see parent::__construct()
     * @param int $_countryCode
     * @param string $_webapiKey
     * @return AllegroStructDoGetServiceTemplatesRequest
     */
