<?php
/**
 * File for class AllegroStructDoGetPostBuyFormsDataForBuyersRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetPostBuyFormsDataForBuyersRequest originally named DoGetPostBuyFormsDataForBuyersRequest
 ...
 * @version 1
 */
class AllegroStructDoGetPostBuyFormsDataForBuyersRequest extends AllegroWsdlClass
{
    /**
     * The sessionId
     * @var string
    ...
    /**
     * Constructor method for DoGetPostBuyFormsDataForBuyersRequest
     * @see parent::__construct()
     * @param string $_sessionId
     * @param AllegroStructArrayOfLong $_transactionsIdsArray
     * @return AllegroStructDoGetPostBuyFormsDataForBuyersRequest
     */
