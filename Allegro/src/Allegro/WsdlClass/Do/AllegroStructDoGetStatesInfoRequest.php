<?php
/**
 * File for class AllegroStructDoGetStatesInfoRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetStatesInfoRequest originally named DoGetStatesInfoRequest
 ...
 * @version 1
 */
class AllegroStructDoGetStatesInfoRequest extends AllegroWsdlClass
{
    /**
     * The countryCode
     * @var int
    ...
    public $webapiKey;
    /**
     * Constructor method for DoGetStatesInfoRequest
     * @see parent::__construct()
     * @param int $_countryCode
     * @param string $_webapiKey
     * @return AllegroStructDoGetStatesInfoRequest
     */
