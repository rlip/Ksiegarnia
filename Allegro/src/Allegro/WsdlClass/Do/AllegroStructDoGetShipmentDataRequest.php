<?php
/**
 * File for class AllegroStructDoGetShipmentDataRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetShipmentDataRequest originally named DoGetShipmentDataRequest
 ...
 * @version 1
 */
class AllegroStructDoGetShipmentDataRequest extends AllegroWsdlClass
{
    /**
     * The countryId
     * @var int
    ...
    public $webapiKey;
    /**
     * Constructor method for DoGetShipmentDataRequest
     * @see parent::__construct()
     * @param int $_countryId
     * @param string $_webapiKey
     * @return AllegroStructDoGetShipmentDataRequest
     */
