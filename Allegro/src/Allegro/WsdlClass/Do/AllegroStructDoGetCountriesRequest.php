<?php
/**
 * File for class AllegroStructDoGetCountriesRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetCountriesRequest originally named DoGetCountriesRequest
 ...
 * @version 1
 */
class AllegroStructDoGetCountriesRequest extends AllegroWsdlClass
{
    /**
     * The countryCode
     * @var int
    ...
    public $webapiKey;
    /**
     * Constructor method for DoGetCountriesRequest
     * @see parent::__construct()
     * @param int $_countryCode
     * @param string $_webapiKey
     * @return AllegroStructDoGetCountriesRequest
     */
