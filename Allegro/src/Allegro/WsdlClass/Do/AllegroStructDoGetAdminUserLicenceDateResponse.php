<?php
/**
 * File for class AllegroStructDoGetAdminUserLicenceDateResponse
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetAdminUserLicenceDateResponse originally named doGetAdminUserLicenceDateResponse
 ...
 * @version 1
 */
class AllegroStructDoGetAdminUserLicenceDateResponse extends AllegroWsdlClass
{
    /**
     * The getDateValue
     * @var float
    ...
    public $getDateValue;
    /**
     * Constructor method for doGetAdminUserLicenceDateResponse
