<?php
/**
 * File for class AllegroStructDoGetCatsDataCountRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetCatsDataCountRequest originally named DoGetCatsDataCountRequest
 ...
 * @version 1
 */
class AllegroStructDoGetCatsDataCountRequest extends AllegroWsdlClass
{
    /**
     * The countryId
     * @var int
    ...
    public $webapiKey;
    /**
     * Constructor method for DoGetCatsDataCountRequest
     * @see parent::__construct()
     * @param int $_countryId
     * @param long $_localVersion
     * @param string $_webapiKey
     * @return AllegroStructDoGetCatsDataCountRequest
     */
