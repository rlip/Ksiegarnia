<?php
/**
 * File for class AllegroStructDoGetMySellItemsRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetMySellItemsRequest originally named DoGetMySellItemsRequest
 ...
 * @version 1
 */
class AllegroStructDoGetMySellItemsRequest extends AllegroWsdlClass
{
    /**
     * The sessionId
     * @var string
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs : 0
     * @var AllegroStructSellFilterOptionsStruct
     */
     ...
     * @return AllegroStructSellFilterOptionsStruct|null
     */
     ...
     * @param AllegroStructSellFilterOptionsStruct $_filterOptions the filterOptions
