<?php
/**
 * File for class AllegroStructDoGetSystemTimeRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetSystemTimeRequest originally named DoGetSystemTimeRequest
 ...
 * @version 1
 */
class AllegroStructDoGetSystemTimeRequest extends AllegroWsdlClass
{
    /**
     * The countryId
     * @var int
    ...
    public $webapiKey;
    /**
     * Constructor method for DoGetSystemTimeRequest
     * @see parent::__construct()
     * @param int $_countryId
     * @param string $_webapiKey
     * @return AllegroStructDoGetSystemTimeRequest
     */
