<?php
/**
 * File for class AllegroStructDoGetSellFormFieldsExtRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetSellFormFieldsExtRequest originally named DoGetSellFormFieldsExtRequest
 ...
 * @version 1
 */
class AllegroStructDoGetSellFormFieldsExtRequest extends AllegroWsdlClass
{
    /**
     * The countryCode
     * @var int
    ...
    public $webapiKey;
    /**
     * Constructor method for DoGetSellFormFieldsExtRequest
     * @see parent::__construct()
     * @param int $_countryCode
     * @param long $_localVersion
     * @param string $_webapiKey
     * @return AllegroStructDoGetSellFormFieldsExtRequest
     */
