<?php
/**
 * File for class AllegroStructDoGetMySoldItemsRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetMySoldItemsRequest originally named DoGetMySoldItemsRequest
 ...
 * @version 1
 */
class AllegroStructDoGetMySoldItemsRequest extends AllegroWsdlClass
{
    /**
     * The sessionId
     * @var string
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs : 0
     * @var AllegroStructSoldFilterOptionsStruct
     */
     ...
     * @return AllegroStructSoldFilterOptionsStruct|null
     */
     ...
     * @param AllegroStructSoldFilterOptionsStruct $_filterOptions the filterOptions
