<?php
/**
 * File for class AllegroStructDoGetItemTemplatesRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetItemTemplatesRequest originally named DoGetItemTemplatesRequest
 ...
 * @version 1
 */
class AllegroStructDoGetItemTemplatesRequest extends AllegroWsdlClass
{
    /**
     * The sessionId
     * @var string
    ...
    /**
     * Constructor method for DoGetItemTemplatesRequest
     * @see parent::__construct()
     * @param string $_sessionId
     * @param AllegroStructArrayOfInt $_itemTemplateIds
     * @return AllegroStructDoGetItemTemplatesRequest
     */
