<?php
/**
 * File for class AllegroStructDoGetSiteJournalDealsRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetSiteJournalDealsRequest originally named DoGetSiteJournalDealsRequest
 ...
 * @version 1
 */
class AllegroStructDoGetSiteJournalDealsRequest extends AllegroWsdlClass
{
    /**
     * The sessionId
     * @var string
    ...
    public $journalStart;
    /**
     * Constructor method for DoGetSiteJournalDealsRequest
     * @see parent::__construct()
     * @param string $_sessionId
     * @param long $_journalStart
     * @return AllegroStructDoGetSiteJournalDealsRequest
     */
