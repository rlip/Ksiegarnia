<?php
/**
 * File for class AllegroStructDoGetPostBuyItemInfoRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetPostBuyItemInfoRequest originally named DoGetPostBuyItemInfoRequest
 ...
 * @version 1
 */
class AllegroStructDoGetPostBuyItemInfoRequest extends AllegroWsdlClass
{
    /**
     * The sessionId
     * @var string
    ...
    public $itemIds;
    /**
     * Constructor method for DoGetPostBuyItemInfoRequest
     * @see parent::__construct()
     * @param string $_sessionId
     * @param AllegroStructArrayOfLong $_itemIds
     * @return AllegroStructDoGetPostBuyItemInfoRequest
     */
