<?php
/**
 * File for class AllegroStructDoFeedbackRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoFeedbackRequest originally named DoFeedbackRequest
 ...
 * @version 1
 */
class AllegroStructDoFeedbackRequest extends AllegroWsdlClass
{
    /**
     * The sessionHandle
     * @var string
    ...
    public $feRating;
    /**
     * Constructor method for DoFeedbackRequest
