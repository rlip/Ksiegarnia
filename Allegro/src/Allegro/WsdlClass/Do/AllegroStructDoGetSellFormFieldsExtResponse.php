<?php
/**
 * File for class AllegroStructDoGetSellFormFieldsExtResponse
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetSellFormFieldsExtResponse originally named doGetSellFormFieldsExtResponse
 ...
 * @version 1
 */
class AllegroStructDoGetSellFormFieldsExtResponse extends AllegroWsdlClass
{
    /**
     * The sellFormFields
     * Meta informations extracted from the WSDL
    ...
    public $verStr;
    /**
     * Constructor method for doGetSellFormFieldsExtResponse
