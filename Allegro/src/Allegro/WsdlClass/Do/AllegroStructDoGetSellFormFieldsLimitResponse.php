<?php
/**
 * File for class AllegroStructDoGetSellFormFieldsLimitResponse
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetSellFormFieldsLimitResponse originally named doGetSellFormFieldsLimitResponse
 ...
 * @version 1
 */
class AllegroStructDoGetSellFormFieldsLimitResponse extends AllegroWsdlClass
{
    /**
     * The sellFormFields
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for doGetSellFormFieldsLimitResponse
