<?php
/**
 * File for class AllegroStructDoGetCatsDataLimitResponse
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetCatsDataLimitResponse originally named doGetCatsDataLimitResponse
 ...
 * @version 1
 */
class AllegroStructDoGetCatsDataLimitResponse extends AllegroWsdlClass
{
    /**
     * The catsList
     * Meta informations extracted from the WSDL
    ...
    public $verStr;
    /**
     * Constructor method for doGetCatsDataLimitResponse
