<?php
/**
 * File for class AllegroStructDoGetShipmentPriceTypesRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetShipmentPriceTypesRequest originally named DoGetShipmentPriceTypesRequest
 ...
 * @version 1
 */
class AllegroStructDoGetShipmentPriceTypesRequest extends AllegroWsdlClass
{
    /**
     * The countryId
     * @var int
    ...
    public $webapiKey;
    /**
     * Constructor method for DoGetShipmentPriceTypesRequest
     * @see parent::__construct()
     * @param int $_countryId
     * @param string $_webapiKey
     * @return AllegroStructDoGetShipmentPriceTypesRequest
     */
