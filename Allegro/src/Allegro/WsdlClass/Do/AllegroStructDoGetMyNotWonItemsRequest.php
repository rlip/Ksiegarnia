<?php
/**
 * File for class AllegroStructDoGetMyNotWonItemsRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetMyNotWonItemsRequest originally named DoGetMyNotWonItemsRequest
 ...
 * @version 1
 */
class AllegroStructDoGetMyNotWonItemsRequest extends AllegroWsdlClass
{
    /**
     * The sessionId
     * @var string
    ...
    public $pageNumber;
    /**
     * Constructor method for DoGetMyNotWonItemsRequest
     ...
     * @return AllegroStructDoGetMyNotWonItemsRequest
     */
