<?php
/**
 * File for class AllegroStructDoGetSiteJournalRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetSiteJournalRequest originally named DoGetSiteJournalRequest
 ...
 * @version 1
 */
class AllegroStructDoGetSiteJournalRequest extends AllegroWsdlClass
{
    /**
     * The sessionHandle
     * @var string
    ...
    public $infoType;
    /**
     * Constructor method for DoGetSiteJournalRequest
     * @see parent::__construct()
     * @param string $_sessionHandle
     * @param long $_startingPoint
     * @param int $_infoType
     * @return AllegroStructDoGetSiteJournalRequest
     */
