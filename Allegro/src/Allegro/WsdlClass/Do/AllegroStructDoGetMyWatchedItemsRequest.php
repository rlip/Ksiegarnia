<?php
/**
 * File for class AllegroStructDoGetMyWatchedItemsRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetMyWatchedItemsRequest originally named DoGetMyWatchedItemsRequest
 ...
 * @version 1
 */
class AllegroStructDoGetMyWatchedItemsRequest extends AllegroWsdlClass
{
    /**
     * The sessionId
     * @var string
    ...
    public $pageNumber;
    /**
     * Constructor method for DoGetMyWatchedItemsRequest
     ...
     * @return AllegroStructDoGetMyWatchedItemsRequest
     */
