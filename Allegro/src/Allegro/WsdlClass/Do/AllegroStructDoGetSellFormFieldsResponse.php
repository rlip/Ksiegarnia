<?php
/**
 * File for class AllegroStructDoGetSellFormFieldsResponse
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetSellFormFieldsResponse originally named doGetSellFormFieldsResponse
 ...
 * @version 1
 */
class AllegroStructDoGetSellFormFieldsResponse extends AllegroWsdlClass
{
    /**
     * The sellFormFields
     * Meta informations extracted from the WSDL
    ...
    public $verStr;
    /**
     * Constructor method for doGetSellFormFieldsResponse
