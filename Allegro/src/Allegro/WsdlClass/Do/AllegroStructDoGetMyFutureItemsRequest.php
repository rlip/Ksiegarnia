<?php
/**
 * File for class AllegroStructDoGetMyFutureItemsRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetMyFutureItemsRequest originally named DoGetMyFutureItemsRequest
 ...
 * @version 1
 */
class AllegroStructDoGetMyFutureItemsRequest extends AllegroWsdlClass
{
    /**
     * The sessionId
     * @var string
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs : 0
     * @var AllegroStructFutureFilterOptionsStruct
     */
    ...
    public $pageNumber;
    /**
     * Constructor method for DoGetMyFutureItemsRequest
     * @see parent::__construct()
     * @param string $_sessionId
     * @param AllegroStructSortOptionsStruct $_sortOptions
     * @param AllegroStructFutureFilterOptionsStruct $_filterOptions
     * @param int $_categoryId
     * @param AllegroStructArrayOfLong $_itemIds
     * @param int $_pageSize
     * @param int $_pageNumber
     * @return AllegroStructDoGetMyFutureItemsRequest
     */
    public function __construct($_sessionId = NULL,$_sortOptions = NULL,$_filterOptions = NULL,$_categoryId = NULL,$_itemIds = NULL,$_pageSize = NULL,$_pageNumber = NULL)
    {
        parent::__construct(array('sessionId'=>$_sessionId,'sortOptions'=>$_sortOptions,'filterOptions'=>$_filterOptions,'categoryId'=>$_categoryId,'itemIds'=>($_itemIds instanceof AllegroStructArrayOfLong)?$_itemIds:new AllegroStructArrayOfLong($_itemIds),'pageSize'=>$_pageSize,'pageNumber'=>$_pageNumber),false);
    }
    /**
     * Get sessionId value
     * @return string|null
     ...
     * @return AllegroStructFutureFilterOptionsStruct|null
     */
     ...
     * @param AllegroStructFutureFilterOptionsStruct $_filterOptions the filterOptions
