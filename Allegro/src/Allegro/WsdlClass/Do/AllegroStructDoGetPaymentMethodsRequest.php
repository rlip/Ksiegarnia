<?php
/**
 * File for class AllegroStructDoGetPaymentMethodsRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetPaymentMethodsRequest originally named DoGetPaymentMethodsRequest
 ...
 * @version 1
 */
class AllegroStructDoGetPaymentMethodsRequest extends AllegroWsdlClass
{
    /**
     * The sessionId
     * @var string
    ...
    public $itemIds;
    /**
     * Constructor method for DoGetPaymentMethodsRequest
     * @see parent::__construct()
     * @param string $_sessionId
     * @param AllegroStructArrayOfLong $_itemIds
     * @return AllegroStructDoGetPaymentMethodsRequest
     */
