<?php
/**
 * File for class AllegroStructDoGetPaymentDataRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetPaymentDataRequest originally named DoGetPaymentDataRequest
 ...
 * @version 1
 */
class AllegroStructDoGetPaymentDataRequest extends AllegroWsdlClass
{
    /**
     * The countryId
     * @var int
    ...
    public $webapiKey;
    /**
     * Constructor method for DoGetPaymentDataRequest
     * @see parent::__construct()
     * @param int $_countryId
     * @param string $_webapiKey
     * @return AllegroStructDoGetPaymentDataRequest
     */
