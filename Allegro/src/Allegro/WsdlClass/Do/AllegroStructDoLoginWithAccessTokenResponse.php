<?php
/**
 * File for class AllegroStructDoLoginWithAccessTokenResponse
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoLoginWithAccessTokenResponse originally named doLoginWithAccessTokenResponse
 ...
 * @version 1
 */
class AllegroStructDoLoginWithAccessTokenResponse extends AllegroWsdlClass
{
    /**
    ...
    public $serverTime;
    /**
     * Constructor method for doLoginWithAccessTokenResponse
