<?php
/**
 * File for class AllegroStructDoGetSellFormFieldsLimitRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetSellFormFieldsLimitRequest originally named DoGetSellFormFieldsLimitRequest
 ...
 * @version 1
 */
class AllegroStructDoGetSellFormFieldsLimitRequest extends AllegroWsdlClass
{
    /**
     * The countryCode
     * @var int
    ...
    /**
     * Constructor method for DoGetSellFormFieldsLimitRequest
     ...
     * @return AllegroStructDoGetSellFormFieldsLimitRequest
     */
