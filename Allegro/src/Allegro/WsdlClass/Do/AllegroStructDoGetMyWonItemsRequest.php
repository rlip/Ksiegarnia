<?php
/**
 * File for class AllegroStructDoGetMyWonItemsRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetMyWonItemsRequest originally named DoGetMyWonItemsRequest
 ...
 * @version 1
 */
class AllegroStructDoGetMyWonItemsRequest extends AllegroWsdlClass
{
    /**
     * The sessionId
     * @var string
    ...
    public $pageNumber;
    /**
     * Constructor method for DoGetMyWonItemsRequest
     ...
     * @return AllegroStructDoGetMyWonItemsRequest
     */
