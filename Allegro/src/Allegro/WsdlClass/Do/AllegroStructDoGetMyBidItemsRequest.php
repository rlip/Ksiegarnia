<?php
/**
 * File for class AllegroStructDoGetMyBidItemsRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetMyBidItemsRequest originally named DoGetMyBidItemsRequest
 ...
 * @version 1
 */
class AllegroStructDoGetMyBidItemsRequest extends AllegroWsdlClass
{
    /**
     * The sessionId
     * @var string
    ...
    public $pageNumber;
    /**
     * Constructor method for DoGetMyBidItemsRequest
     ...
     * @return AllegroStructDoGetMyBidItemsRequest
     */
