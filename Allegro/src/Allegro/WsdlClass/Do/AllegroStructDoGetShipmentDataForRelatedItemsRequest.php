<?php
/**
 * File for class AllegroStructDoGetShipmentDataForRelatedItemsRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetShipmentDataForRelatedItemsRequest originally named DoGetShipmentDataForRelatedItemsRequest
 ...
 * @version 1
 */
class AllegroStructDoGetShipmentDataForRelatedItemsRequest extends AllegroWsdlClass
{
    /**
     * The sessionId
     * @var string
    ...
    public $itemIds;
    /**
     * Constructor method for DoGetShipmentDataForRelatedItemsRequest
     * @see parent::__construct()
     * @param string $_sessionId
     * @param AllegroStructArrayOfLong $_itemIds
     * @return AllegroStructDoGetShipmentDataForRelatedItemsRequest
     */
