<?php
/**
 * File for class AllegroStructDoGetRelatedItemsRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetRelatedItemsRequest originally named DoGetRelatedItemsRequest
 ...
 * @version 1
 */
class AllegroStructDoGetRelatedItemsRequest extends AllegroWsdlClass
{
    /**
     * The sessionId
     * @var string
    ...
    public $itemIds;
    /**
     * Constructor method for DoGetRelatedItemsRequest
     * @see parent::__construct()
     * @param string $_sessionId
     * @param AllegroStructArrayOfLong $_itemIds
     * @return AllegroStructDoGetRelatedItemsRequest
     */
