<?php
/**
 * File for class AllegroStructDoSellSomeAgainResponse
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoSellSomeAgainResponse originally named doSellSomeAgainResponse
 ...
 * @version 1
 */
class AllegroStructDoSellSomeAgainResponse extends AllegroWsdlClass
{
    /**
     * The itemsSellAgain
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for doSellSomeAgainResponse
