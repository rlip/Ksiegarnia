<?php
/**
 * File for class AllegroStructDoGetSitesInfoRequest
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructDoGetSitesInfoRequest originally named DoGetSitesInfoRequest
 ...
 * @version 1
 */
class AllegroStructDoGetSitesInfoRequest extends AllegroWsdlClass
{
    /**
     * The countryCode
     * @var int
    ...
    public $webapiKey;
    /**
     * Constructor method for DoGetSitesInfoRequest
     * @see parent::__construct()
     * @param int $_countryCode
     * @param string $_webapiKey
     * @return AllegroStructDoGetSitesInfoRequest
     */
