<?php
/**
 * File for class AllegroStructBidItemStruct
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructBidItemStruct originally named BidItemStruct
 ...
 * @version 1
 */
class AllegroStructBidItemStruct extends AllegroWsdlClass
{
    /**
     * The itemId
     * @var long
    ...
    /**
     * Set itemBidQuantity value
     * @param int $_itemBidQuantity the itemBidQuantity
     * @return int
     */
    public function setItemBidQuantity($_itemBidQuantity)
    {
        return ($this->itemBidQuantity = $_itemBidQuantity);
    }
    /**
