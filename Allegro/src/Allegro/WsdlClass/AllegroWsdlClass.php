<?php
/**
 * File for AllegroWsdlClass to communicate with SOAP service
 * @package Allegro
 * @date 2015-04-14
 * @author Roman Lip
 * @version 1
 */
/**
 * AllegroWsdlClass to communicate with SOAP service
 * 
 * @package Allegro
 * @date 2015-04-14
 * @author Roman Lip
 * @version 1
 */
class AllegroWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'https://webapi.allegro.pl/service.php?wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses AllegroWsdlClass::setLastError()
     * @uses AllegroWsdlClass::initSoapClient()
     * @uses AllegroWsdlClass::initInternArrayToIterate()
     * @uses AllegroWsdlClass::_set()
    ...
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'AllegroWsdlClass'))
            {
     ...
     * @uses AllegroClassMap::classMap()
     * @uses AllegroWsdlClass::getDefaultWsdlOptions()
     * @uses AllegroWsdlClass::getSoapClientClassName()
     * @uses AllegroWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('AllegroClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = AllegroClassMap::classMap();
     ...
     * If a class is named as {Allegro}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('AllegroSoapClient') && is_subclass_of('AllegroSoapClient','SoapClient'))
            return 'AllegroSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses AllegroWsdlClass::WSDL_CACHE_WSDL
     * @uses AllegroWsdlClass::WSDL_COMPRESSION
     * @uses AllegroWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses AllegroWsdlClass::WSDL_ENCODING
     * @uses AllegroWsdlClass::WSDL_EXCEPTIONS
     * @uses AllegroWsdlClass::WSDL_FEATURES
     * @uses AllegroWsdlClass::WSDL_LOGIN
     * @uses AllegroWsdlClass::WSDL_PASSWORD
     * @uses AllegroWsdlClass::WSDL_SOAP_VERSION
     * @uses AllegroWsdlClass::WSDL_STREAM_CONTEXT
     * @uses AllegroWsdlClass::WSDL_TRACE
     * @uses AllegroWsdlClass::WSDL_TYPEMAP
     * @uses AllegroWsdlClass::WSDL_URL
     * @uses AllegroWsdlClass::VALUE_WSDL_URL
     * @uses AllegroWsdlClass::WSDL_USER_AGENT
     * @uses AllegroWsdlClass::WSDL_PROXY_HOST
     * @uses AllegroWsdlClass::WSDL_PROXY_PORT
     * @uses AllegroWsdlClass::WSDL_PROXY_LOGIN
     * @uses AllegroWsdlClass::WSDL_PROXY_PASSWORD
     * @uses AllegroWsdlClass::WSDL_LOCAL_CERT
     * @uses AllegroWsdlClass::WSDL_PASSPHRASE
     * @uses AllegroWsdlClass::WSDL_AUTHENTICATION
     * @uses AllegroWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses AllegroWsdlClass::getSoapClient()
     * @uses AllegroWsdlClass::getFormatedXml()
     ...
     * @uses AllegroWsdlClass::getSoapClient()
     * @uses AllegroWsdlClass::convertStringHeadersToArray()
     ...
     * @uses AllegroWsdlClass::getInternArrayToIterate()
     * @uses AllegroWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses AllegroWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses AllegroWsdlClass::getInternArrayToIterateOffset()
     * @uses AllegroWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses AllegroWsdlClass::getInternArrayToIterateOffset()
     * @uses AllegroWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see AllegroWsdlClass::offsetGet()
     * @uses AllegroWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses AllegroWsdlClass::getAttributeName()
     * @uses AllegroWsdlClass::__toString()
     * @uses AllegroWsdlClass::_set()
     * @uses AllegroWsdlClass::_get()
     * @uses AllegroWsdlClass::setInternArrayToIterate()
     * @uses AllegroWsdlClass::setInternArrayToIterateIsArray()
     * @uses AllegroWsdlClass::setInternArrayToIterateOffset()
