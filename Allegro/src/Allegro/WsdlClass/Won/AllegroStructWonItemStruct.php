<?php
/**
 * File for class AllegroStructWonItemStruct
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructWonItemStruct originally named WonItemStruct
 ...
 * @version 1
 */
class AllegroStructWonItemStruct extends AllegroWsdlClass
{
    /**
     * The itemId
     * @var long
    ...
    public $itemPrice;
    /**
     * The itemBoughtQuantity
     * @var int
     */
    public $itemBoughtQuantity;
    /**
     ...
     */
    public function __construct($_itemId = NULL,$_itemTitle = NULL,$_itemThumbnailUrl = NULL,$_itemPrice = NULL,$_itemBoughtQuantity = NULL,$_itemLeftQuantity = NULL,$_itemQuantityType = NULL,$_itemEndTime = NULL,$_itemEndTimeLeft = NULL,$_itemSeller = NULL,$_itemBiddersCounter = NULL,$_itemCategoryId = NULL,$_itemViewsCounter = NULL,$_itemNote = NULL,$_itemSpecialInfo = NULL,$_itemShopInfo = NULL,$_itemProductInfo = NULL,$_itemPayuInfo = NULL)
    {
        parent::__construct(array('itemId'=>$_itemId,'itemTitle'=>$_itemTitle,'itemThumbnailUrl'=>$_itemThumbnailUrl,'itemPrice'=>($_itemPrice instanceof AllegroStructArrayOfItempricestruct)?$_itemPrice:new AllegroStructArrayOfItempricestruct($_itemPrice),'itemBoughtQuantity'=>$_itemBoughtQuantity,'itemLeftQuantity'=>$_itemLeftQuantity,'itemQuantityType'=>$_itemQuantityType,'itemEndTime'=>$_itemEndTime,'itemEndTimeLeft'=>$_itemEndTimeLeft,'itemSeller'=>$_itemSeller,'itemBiddersCounter'=>$_itemBiddersCounter,'itemCategoryId'=>$_itemCategoryId,'itemViewsCounter'=>$_itemViewsCounter,'itemNote'=>$_itemNote,'itemSpecialInfo'=>$_itemSpecialInfo,'itemShopInfo'=>$_itemShopInfo,'itemProductInfo'=>$_itemProductInfo,'itemPayuInfo'=>$_itemPayuInfo),false);
    }
    /**
     * Get itemId value
     * @return long|null
    ...
    /**
     * Set itemBoughtQuantity value
     * @param int $_itemBoughtQuantity the itemBoughtQuantity
     * @return int
     */
    public function setItemBoughtQuantity($_itemBoughtQuantity)
    {
        return ($this->itemBoughtQuantity = $_itemBoughtQuantity);
    }
    /**
