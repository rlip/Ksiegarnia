<?php
/**
 * File for class AllegroStructArrayOfInt
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructArrayOfInt originally named ArrayOfInt
 ...
 * @version 1
 */
class AllegroStructArrayOfInt extends AllegroWsdlClass
{
    /**
     * The item
     * Meta informations extracted from the WSDL
