<?php
/**
 * File for class AllegroStructArrayOfString
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructArrayOfString originally named ArrayOfString
 ...
 * @version 1
 */
class AllegroStructArrayOfString extends AllegroWsdlClass
{
    /**
     * The item
     * Meta informations extracted from the WSDL
