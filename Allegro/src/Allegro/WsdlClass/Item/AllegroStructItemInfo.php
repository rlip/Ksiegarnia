<?php
/**
 * File for class AllegroStructItemInfo
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructItemInfo originally named ItemInfo
 ...
 * @version 1
 */
class AllegroStructItemInfo extends AllegroWsdlClass
{
    /**
     * The itId
     * @var long
     ...
     * @param AllegroStructDurationInfoStruct $_itDurationInfo
     * @return AllegroStructItemInfo
     */
    public function __construct($_itId = NULL,$_itCountry = NULL,$_itName = NULL,$_itPrice = NULL,$_itBidCount = NULL,$_itEndingTime = NULL,$_itSellerId = NULL,$_itSellerLogin = NULL,$_itSellerRating = NULL,$_itStartingTime = NULL,$_itStartingPrice = NULL,$_itQuantity = NULL,$_itFotoCount = NULL,$_itReservePrice = NULL,$_itLocation = NULL,$_itBuyNowPrice = NULL,$_itBuyNowActive = NULL,$_itHighBidder = NULL,$_itHighBidderLogin = NULL,$_itDescription = NULL,$_itOptions = NULL,$_itState = NULL,$_itIsEco = NULL,$_itHitCount = NULL,$_itPostcode = NULL,$_itVatInvoice = NULL,$_itBankAccount1 = NULL,$_itBankAccount2 = NULL,$_itStartingQuantity = NULL,$_itIsForGuests = NULL,$_itHasProduct = NULL,$_itOrderFulfillmentTime = NULL,$_itEndingInfo = NULL,$_itIsAllegroStandard = NULL,$_itIsNewUsed = NULL,$_itIsBrandZone = NULL,$_itDurationInfo = NULL)
    {
        parent::__construct(array('itId'=>$_itId,'itCountry'=>$_itCountry,'itName'=>$_itName,'itPrice'=>$_itPrice,'itBidCount'=>$_itBidCount,'itEndingTime'=>$_itEndingTime,'itSellerId'=>$_itSellerId,'itSellerLogin'=>$_itSellerLogin,'itSellerRating'=>$_itSellerRating,'itStartingTime'=>$_itStartingTime,'itStartingPrice'=>$_itStartingPrice,'itQuantity'=>$_itQuantity,'itFotoCount'=>$_itFotoCount,'itReservePrice'=>$_itReservePrice,'itLocation'=>$_itLocation,'itBuyNowPrice'=>$_itBuyNowPrice,'itBuyNowActive'=>$_itBuyNowActive,'itHighBidder'=>$_itHighBidder,'itHighBidderLogin'=>$_itHighBidderLogin,'itDescription'=>$_itDescription,'itOptions'=>$_itOptions,'itState'=>$_itState,'itIsEco'=>$_itIsEco,'itHitCount'=>$_itHitCount,'itPostcode'=>$_itPostcode,'itVatInvoice'=>$_itVatInvoice,'itBankAccount1'=>$_itBankAccount1,'itBankAccount2'=>$_itBankAccount2,'itStartingQuantity'=>$_itStartingQuantity,'itIsForGuests'=>$_itIsForGuests,'itHasProduct'=>$_itHasProduct,'itOrderFulfillmentTime'=>$_itOrderFulfillmentTime,'itEndingInfo'=>$_itEndingInfo,'itIsAllegroStandard'=>$_itIsAllegroStandard,'itIsNewUsed'=>$_itIsNewUsed,'itIsBrandZone'=>$_itIsBrandZone,'itDurationInfo'=>$_itDurationInfo),false);
    }
    /**
     * Get itId value
     * @return long|null
    ...
    /**
     * Set itDurationInfo value
     * @param AllegroStructDurationInfoStruct $_itDurationInfo the itDurationInfo
     * @return AllegroStructDurationInfoStruct
     */
    public function setItDurationInfo($_itDurationInfo)
    {
        return ($this->itDurationInfo = $_itDurationInfo);
    }
    /**
