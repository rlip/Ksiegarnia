<?php
/**
 * File for class AllegroStructNotSoldFilterOptionsStruct
 * @package Allegro
 * @subpackage Structs
 * @date 2015-04-14
 * @author Roman Lip
 ...
 */
/**
 * This class stands for AllegroStructNotSoldFilterOptionsStruct originally named NotSoldFilterOptionsStruct
 ...
 * @version 1
 */
class AllegroStructNotSoldFilterOptionsStruct extends AllegroWsdlClass
{
    /**
     * The filterFormat
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for NotSoldFilterOptionsStruct
